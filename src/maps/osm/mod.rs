...
impl<'a> OsmClient<'a> {
        ...
        for element in elements {
            ...
            match element_type {
                "node" => {
                    ...
                    let tags = element
                        ...
                        .map(|obj| {
                            ...
                            tag_map.extend(obj.iter().filter_map(|(k, v)| {
                ...
                "way" => {
                    ...
                    way_nodes.extend(nodes_array.iter().filter_map(|n| n.as_i64()));
                ...
                "relation" => {
                    ...
                    members.extend(members_array.iter().filter_map(|m| {
    ...
    pub async fn find_pois_near_location(
        &self,
        lon: f64,
        lat: f64,
        radius_meters: u32,
    ...
    pub async fn generate_map_image(
        &self,
        center: Point,
        zoom: u8,
        width: u32,
